#Mission:create a Python class that contains a collection of methods. String data should be stored in an array-based structure.
...
class StringClass:
    ...
    def search(self, target_char):
        #check the each item in list and see if it equal to target character
    ...
    #change all of uppercase to lowercase in list
    def lowercase(self):
